...
export default function Capitulos() {
  ...
  const time = (10982/wpm).toFixed(1);
    ...
    <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
      {selectedExercise ? (
        ...
        <ScrollView contentContainerStyle={styles.container}>
          ...
          <ScrollView>
            <Pressable onPress={() => handleExerciseSelect("twoWords", texts.Capitulo1F2.content)}>
              <ChapterCard
                title="Capitulo 1"
                wordCount={texts.Capitulo1F2.wordCount}
                wpm={wpm}
                exerciseType="twoWords"
                textContent={texts.Capitulo1F2.content}
              />
            </Pressable>
            <Pressable onPress={() => handleExerciseSelect("exercise1", texts.Capitulo2F2.content)}>
              <ChapterCard
                title="Capitulo 2"
                wordCount={texts.Capitulo2F2.wordCount}
                wpm={wpm}
                exerciseType="exercise1"
                textContent={texts.Capitulo2F2.content}
              />
            </Pressable>
            <Pressable onPress={() => handleExerciseSelect("twoWords", texts.Capitulo3F2.content)}>
              <ChapterCard
                title="Capitulo 3"
                wordCount={texts.Capitulo3F2.wordCount}
                wpm={wpm}
                exerciseType="twoWords"
                textContent={texts.Capitulo3F2.content}
              />
            </Pressable>
