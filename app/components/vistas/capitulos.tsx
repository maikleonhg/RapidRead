...
export default function Capitulos() {
  ...
  // Cambia el tipo de selectedExercise para permitir null o un objeto de tipo Exercise
  ...
  return (
    <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
      {selectedExercise ? (
        // Si hay un ejercicio seleccionado, renderizamos el ExerciseWrapper
        <ExerciseWrapper 
        ...
        <ScrollView contentContainerStyle={styles.container}>
          ...
          <ScrollView>
            ...
            <Pressable onPress={() => handleExerciseSelect("twoWords", texts.Capitulo2F1.content)}>
              <ChapterCard
                title="Capitulo 2"
            ...
            <Pressable onPress={() => handleExerciseSelect("twoWords", texts.Capitulo3F1.content)}>
              <ChapterCard
                title="Capitulo 3"
